...
Một chatbot AI thông minh để hỗ trợ nhân viên Việt Nam trong việc báo cáo chi phí, trả lời các câu hỏi về chính sách và tính toán hoàn tiền một cách tự động. Hỗ trợ cả giao diện dòng lệnh và web.
...
- **format_expense_summary()**: Định dạng tóm tắt

### `cli.py`
- **run_interactive_chat()**: Chat tương tác
- **quick_test()**: Test nhanh
- **quick_demo()**: Demo nhanh
...
- **System Info**: Hiển thị trạng thái hệ thống và thống kê
...
- `GET /api/system_info` - Thông tin hệ thống
